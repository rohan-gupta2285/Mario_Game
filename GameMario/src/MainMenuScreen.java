...
public class MainMenuScreen implements Screen {
	...
	private void create() {
		...
		title.setTexture( new Texture(Gdx.files.internal("Title1.png")) ); //adds "Super Runner" title
		...
		TextButton newGameButton = new TextButton("Play", skin); // Uses the initialized skin
